// Problem statement
// Your next task is to create a program to determine whether a Student is eligible for an Award or not if they are eligible store true in the answer else store false.
// Before getting eligible for the award he needs to be either eligible for a scholarship or should be participating in the Science fair function.
// Given below are the eligibility criteria for the Scholarship, Science Fair Particion, and the Award.
// Scholarship Eligibility:
// A student is eligible for a scholarship if they score above 80 in at least two out of the three subjects.// Science Fair Participation:
...
function isEligible(mathScore , englishScore , scienceScore) {
   ...
   if ((mathScore > 80 && englishScore >80)|| (englishScore >80 && scienceScore>80) || (mathScore > 80 && scienceScore>80)) {
    return true;
   }
   eligibleForAward = mathScore + englishScore + scienceScore >=250;
